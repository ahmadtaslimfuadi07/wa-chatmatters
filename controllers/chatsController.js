import { getSession, getChatList, isExists, sendMessage, formatPhone, downloadMediaMessage } from './../whatsapp.js'
...
const download = async (req, res) => {
    ...
    try {
        ...
        response(res, 500, false, 'Failed to download file message.')
    }
}

export { getList, send, sendBulk, download }
