...
<ul class="navbar-nav">
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/cron-job*') ? 'active' : '' }}"
            href="{{ route('admin.cron-job.index') }}">
...
<ul class="navbar-nav">
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/devices*') ? 'active' : '' }}"
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/template*') ? 'active' : '' }}"
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/message-transactions*') ? 'active' : '' }}"
            href="{{ route('admin.message-transactions.index') }}">
            <i class="fi  fi-rs-comments"></i>
            <span class="nav-link-text">{{ __('Messages') }}</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/broadcast*') ? 'active' : '' }}"
...
<ul class="navbar-nav">
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/blog*') || Request::is('admin/category*') || Request::is('admin/tag*') ? 'active' : '' }}"
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/features*') ? 'active' : '' }}"
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/partner*') ? 'active' : '' }}"
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/language*') ? 'active' : '' }}"
...
<ul class="navbar-nav mb-md-3">
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/admin*') || Request::is('admin/role*') ? 'active' : '' }}"
            href="#admin-roles" data-toggle="collapse" role="button" aria-expanded="false"
            aria-controls="navbar-forms">
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('admin/developer-settings*') ? 'active' : '' }}" href="#dev-settings"
            data-toggle="collapse" role="button" aria-expanded="false" aria-controls="navbar-forms">
        ...
        <div class="collapse" id="dev-settings">
            <ul class="nav nav-sm flex-column">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.developer-settings.show', 'app-settings') }}"
                        class="nav-link">{{ __('App Settings') }}</a>
                </li>

                <li class="nav-item">
                    <a href="{{ route('admin.developer-settings.show', 'mail-settings') }}"
                        class="nav-link">{{ __('SMTP Settings') }}</a>
                </li>

                <li class="nav-item">
                    <a href="{{ route('admin.developer-settings.show', 'wa-settings') }}"
                        class="nav-link">{{ __('Whatsapp Server') }}</a>
                </li>

                <li class="nav-item">
                    <a href="{{ route('admin.developer-settings.show', 'storage-settings') }}"
                        class="nav-link">{{ __('Storage Settings') }}</a>
                </li>
