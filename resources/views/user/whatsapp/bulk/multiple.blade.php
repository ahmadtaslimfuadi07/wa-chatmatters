		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group receivers-list">
					...
					<select class="form-control select2" id="wa-contacts"  name="group">
				...
				<div class="form-group">
					...
					<textarea class="form-control h-200" required="" id="wa_temp_message" maxlength="1000"></textarea>
					<span class="text-danger message_alert none">{{ __('Add The Message') }}</span>
				</div>

			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-outline-primary col-6" data-dismiss="modal">{{ __('Close') }}</button>
				<button type="submit" class="btn btn-outline-primary col-6" >{{ __('Import') }}</button>
			</div>	
			</form>
		</div>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<textarea class="form-control" required="" id="to" placeholder="{{ __('Use comma for multiple numbers') }}"></textarea>
...
<script src="{{ asset('assets/js/pages/bulk/bulkmessage.js?v=1.2') }}" ></script>
