        ...
        <div class="row justify-content-center">
            <div class="col-sm-12">
                <div class="alert bg-gradient-primary text-white alert-dismissible fade show success-alert" role="alert">
                    <span class="alert-text"><strong>{{ __('Hi. ') . Auth::user()->name }}</strong>
                        {{ __('Welcome to ') . env('APP_NAME') }} {{ Session::get('new-user') }}</span>
                ...
                <form method="POST" class="ajaxform_instant_reload" action="{{ route('user.device.store') }}">
                    ...
                    @if (Auth::user()->id == 114)
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="phone" placeholder="628123456789" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="remark" placeholder="Device TPS 1" class="form-control">
                            </div>
                        </div>
                    @endif
                    <div class="form-group row mb-4">
