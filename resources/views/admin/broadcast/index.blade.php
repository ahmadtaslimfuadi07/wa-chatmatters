                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="col-1">{{ __('Image') }}</th>
                                <th class="col-1">{{ __('Desc') }}</th>
                                <th class="col-1">{{ __('Interval') }}</th>
                                <th class="col-1">{{ __('Limit Contact') }}</th>
                            ...
                            <tbody class="list">
                                @foreach ($broadcasts ?? [] as $broadcast)
                                    <tr>
                                        ...
                                        <td class="text-wrap">{{ $broadcast['body'] ?? '' }}</td>
                                        <td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.broadcast.show', $broadcast['_id']) }}">{{ __('Logs') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
